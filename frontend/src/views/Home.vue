    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <h1 class="main-title">
            {{ $t('home.heroTitle') }}<br>
            <span class="gradient-text">{{ $t('home.heroTitleGradient') }}</span>
          </h1>
          
          <div class="hero-desc">
            <p v-html="heroDescHtml"></p>
            <p class="slogan-text">
              {{ $t('home.heroSlogan') }}<span class="blinking-cursor">_</span>
            </p>
          </div>
          ...
          <div class="steps-container">
            ...
            <div class="workflow-list">
              <div class="workflow-item">
                ...
                <div class="step-info">
                  <div class="step-title">{{ $t('common.workflow.step1') }}</div>
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  <div class="step-title">{{ $t('common.workflow.step2') }}</div>
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  <div class="step-title">{{ $t('common.workflow.step3') }}</div>
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  <div class="step-title">{{ $t('common.workflow.step4') }}</div>
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  <div class="step-title">{{ $t('common.workflow.step5') }}</div>
          ...
          <div class="console-box">
            ...
            <div class="console-section">
              <div class="console-header">
                ...
                <span class="console-meta">{{ $t('home.consoleFormats') }}</span>
              </div>
...
const heroDescHtml = computed(() => {
  return t('home.heroDesc1', {
    brand: '<span class="highlight-bold">MiroFish</span>',
    agentScale: '<span class="highlight-orange">' + t('home.agentScale') + '</span>',
    optimalSolution: '<span class="highlight-code">' + t('home.optimalSolution') + '</span>'
  })
})
