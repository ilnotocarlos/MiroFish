    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        <div class="card-header">
          ...
          <div class="step-status">
            ...
            <span v-else-if="currentPhase === 0" class="badge processing">{{ $t('common.status.generating') }}</span>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="currentPhase >= 2" class="badge accent">{{ $t('common.status.inProgress') }}</span>
          </div>
        </div>
        ...
        <div class="card-content">
          ...
          >
            ...
            {{ creatingSimulation ? $t('common.status.creating') : $t('step1.enterEnvSetup') }}
          </button>
        </div>
      </div>
    </div>
