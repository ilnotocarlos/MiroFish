...
class ZepEntityReader:
    ...
    def get_all_nodes(self, graph_id: str) -> List[Dict[str, Any]]:
        ...
        Returns:
            List of nodes
        """
        logger.info(f"Recupero tutti i nodi del grafo {graph_id}...")
        ...
        logger.info(f"Recuperati {len(nodes_data)} nodi totali")
        return nodes_data
    ...
    def get_all_edges(self, graph_id: str) -> List[Dict[str, Any]]:
        ...
        Returns:
            List of edges
        """
        logger.info(f"Recupero tutti gli archi del grafo {graph_id}...")
        ...
        logger.info(f"Recuperati {len(edges_data)} archi totali")
        return edges_data
    ...
    def filter_defined_entities(
        ...
        """
        logger.info(f"Inizio filtraggio entita del grafo {graph_id}...")
        ...
        logger.info(f"Filtraggio completato: nodi totali {total_count}, corrispondenti {len(filtered_entities)}, "
                   f"tipi entita: {entity_types_found}")
    ...
    def get_entity_with_context(
        ...
        try:
            ...
            logger.error(f"Recupero entita {entity_uuid} fallito: {str(e)}")
            return None
